...
<body>
    <div style="text-align:center;">
        ...
        <p style="text-align:center; margin:0; font-size:14px;">Sales Payments List</p>
        ...
        @if ($request->payments_method)
            <p style="text-align:center; margin:0; font-size:12px; text-transform: capitalize">Payment Method:
                {{ getArrayData(paymentMethods(), $request->payments_method) }}</p>
        @endif
    ...
    <div style="display: flex; justify-content: center; margin-top: 10px; overflow-x: auto;">
        <table
            style="min-width:500px; margin: 0 auto; text-align: center; font-size:10px; border-collapse: collapse; border: 1px solid #000; ">
            <thead>
                <tr role="row">
            ...
            <tbody>
                @foreach ($payments as $payment)
                    <tr role="row" class="odd">
                        ...
                        <td style="border: 1px solid #00;">
                            {{ getArrayData(paymentMethods(), $payment->payment_method) }}</td>
