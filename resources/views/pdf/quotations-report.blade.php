...
<body>
    ...
    <div class="filter-info">
        ...
        Total: {{ $quotations->count() }} quotation(s)
    </div>
        ...
        <tbody>
            @forelse ($quotations as $quotation)
                <tr>
                    ...
                    <td>{{ $quotation->expiry_date->format('d-m-Y') }}</td>
                    <td>{{ number_format($quotation->total_amount, 2) }} Tk</td>
                </tr>
            @empty
                <tr>
                    <td colspan="6" style="text-align:center;">No quotations found</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="in-words">
        ...
        <strong>Total Amount:</strong> {{ number_format($quotations->sum('total_amount'), 2) }} Tk
    </div>
