                        ...
                        <div class="input-block mb-3">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="client_type" id="newClient" value="new" {{ $project->client_id ? '' : 'checked' }}>
                                    <label class="form-check-label" for="newClient">New Client</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="client_type" id="existingClient" value="existing" {{ $project->client_id ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="input-block mb-3">
                                ...
                                <select name="existing_client_id" class="form-control" id="clientSelect" {{ $project->client_id ? 'required' : '' }}>
