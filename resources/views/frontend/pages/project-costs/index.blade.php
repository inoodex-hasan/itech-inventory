...
<div class="content container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">All Project Costs</h3>
            </div>
            <div class="col-auto">
                                        ...
                                        <ul>
                                            {{-- <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('project-costs.show', $cost->id) }}">
                                            ...
                                            <li>
                                                ...
                                                <form id="serviceDelete{{ $cost->id }}"
                                                    action="{{ route('project-costs.destroy', $cost->id) }}" method="POST"
                                                    style="display:none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
