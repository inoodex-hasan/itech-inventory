                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            @foreach($grouped as $projectId => $items)
                                ...
                                <!-- Main Project Row (Collapsible Trigger) -->
                                <tr class=" fw-bold" style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#{{ $rowId }}" aria-expanded="false">
                                    <td>
                                        <i class="fas fa-chevron-right collapse-icon me-2"></i>
                                    </td>
                                    <td colspan="1">
                                        {{ $project->project_name }}
                                        <small class="text-muted d-block">{{ $itemCount }} item{{ $itemCount > 1 ? 's' : '' }}</small>
                                    </td>
                                    <td colspan="1"></td>
                                    <td>{{ $totalQty }}</td>
